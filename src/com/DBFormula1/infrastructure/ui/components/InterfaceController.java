...
import com.DBFormula1.infrastructure.ui.mainWindow.FindFormula1;
import com.DBFormula1.infrastructure.ui.mainWindow.FormFormula1;
...
public class InterfaceController {
    ...
    public InterfaceController(JFrame windowMain) {
        ...
        FindFormula1 findFormula1 = new FindFormula1(this);
        FormFormula1 formFormula1 = new FormFormula1(this);
        ...
        CONTAINER.add(findFormula1, "FindPanel");
        CONTAINER.add(formFormula1, "FormPanel");
